...
export default function Description() {
  return (
    <div className='flex flex-col items-center justify-center my-24 p-6 md:px-28'>
      ...
      <div className='flex flex-col gap-5 md:gap-14 sm:flex-row items-center justify-center'>
        <img src={assets.sample_img_1} alt="ai generate image" className='w-80 xl:w-96 rounded-lg' />
        <div>
